    ...
    <footer className="bg-neutral-800 text-gray-300 mt-40">
      <div className="max-w-7xl mx-auto md:px-20 py-10 flex flex-col md:flex-row md:justify-between gap-8">
        ...
        <div className="flex items-center justify-center gap-4">
            <a href="https://instagram.com/nivix.co" target="_blank"><span className="text-[#F4B400]"><FaInstagram size={35} /></span></a>
            <span className="text-[#F4B400]"><FaFacebook size={35} /></span>
            <span className="text-[#F4B400]"><FaLinkedin size={35} /></span>
        </div>
      </div>
